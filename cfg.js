...
(function(){
  var rawCfg = {
    lowerBound: "2018-01-12 07:00:00",
    upperBound: "2018-01-19 07:00:00",
    excepts: {
      "1": [ "2018-01-13 00:00:00", "2018-01-15 21:00:00" ],
      "2": [ "2018-01-18 00:00:00", "2018-01-21 21:00:00" ]
    }
  };
  ...
  function cook(rawCfg) {
    return {
      lowerBound: new Date(rawCfg.lowerBound),
      upperBound: new Date(rawCfg.upperBound),
  ...
  function renderExceptInputs(container) {
    ...
    exceptInputBlock.querySelector("#except_commit")
      .addEventListener("click", function(){
        var exceptFrom = exceptInputBlock.querySelector("#except_from").value;
        var exceptTo = exceptInputBlock.querySelector("#except_to").value;
        rawCfg.excepts[IDProvider.next()] = [exceptFrom, exceptTo];
        renderExceptions(container, cook(rawCfg));
      });
  ...
  function store(cfg) {
    console.log("cout << save configuration to local storage: ", cfg);
  }
